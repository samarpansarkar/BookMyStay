    ...
    return (
        <header className='relative flex max-w-7xl flex-col overflow-hidden px-4 py-4 text-slate-700 md:mx-auto md:flex-row md:items-center'>
            ...
            <nav
                ...
                className={`flex w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-24 md:max-h-full md:flex-row md:items-start ${isOpen ? "max-h-56 mt-8" : "max-h-0 md:max-h-full"}`}>
                <ul className='flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0'>
                    <li className='md:mr-12'>
                        <Link
                            href='/membership'
                            className={pathname === "/membership" ? "font-bold text-lg text-green-500" : "hover:text-green-500 transition-colors"}>
                            Membership
                        </Link>
                    </li>
                    <li className='md:mr-12'>
                        <Link
                            href='/features'
                            className={pathname === "/features" ? "font-bold text-lg text-green-500" : "hover:text-green-500 transition-colors"}>
                            Features
                        </Link>
                    </li>
                    <li className='md:mr-12'>
                        <Link
                            href='/support'
                            className={pathname === "/support" ? "font-bold text-lg text-green-500" : "hover:text-green-500 transition-colors"}>
                            Support
                        </Link>
                    </li>
