  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4 sm:px-6 lg:px-8 relative overflow-hidden py-12">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-5%] right-[-5%] w-125 h-125 bg-green-200/50 rounded-full mix-blend-multiply blur-[100px] opacity-70"></div>
        <div className="absolute bottom-[-5%] left-[-5%] w-150 h-150 bg-emerald-200/40 rounded-full mix-blend-multiply blur-[120px] opacity-70"></div>
      </div>
